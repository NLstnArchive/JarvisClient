...
public class FileSystem {
	...
	public static File					DESKTOP_LOCATION;
	public static File					JARVIS_HOME;
	...
	public static void init() {
		...
		String jarvisHome = "C:/Jarvis/";
		JARVIS_HOME = new File(jarvisHome);
		mount("jarvisHome", jarvisHome);
		String desktop = System.getProperty("user.home") + "/Desktop/";
		DESKTOP_LOCATION = new File(desktop);
